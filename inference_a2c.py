...
# Result Saving
save_folder_name = "251221_A2C"
RESULTS_DIR = os.path.join(BASE_DIR, 'results_A2C', save_folder_name)
SAVE_DIR = os.path.join(RESULTS_DIR, 'prediction_mask')
MODEL_PATH = os.path.join(BASE_DIR, 'results_A2C', save_folder_name, "final_a2c_model.zip") 
...
def main():
    ...
    agent = A2C.load(MODEL_PATH, device=DEVICE)
