...
# Result Saving
save_folder_name = "251213_useLessPoint"
RESULTS_DIR = os.path.join(BASE_DIR, 'results_ppo', save_folder_name)
SAVE_DIR = os.path.join(RESULTS_DIR, 'prediction_mask')
MODEL_PATH = os.path.join(BASE_DIR, 'results_ppo', save_folder_name, "final_ppo_model.zip") 
